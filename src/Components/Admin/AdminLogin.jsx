      ...
      <div className="add">
        <div className="container">
          <div className="fw_90">
            <div className="add_0">
              <div className="im09">
                {/* <img src="../Assets/logo.png" alt="login" className="di_90" /> */}
                <div className="d-flex gap-2">
              <a href="/" className="tail-text">
                <img src="../Assets/logo.png" alt="Logo" className="admin-login-logo" />
              </a>
              <div className="H_logo">
                <h4 className="mb-0 text-uppercase" style={{marginTop:"20px"}}>Sri Venkateshwara</h4>
                <p className="inter-national" style={{ margin:"0px -12px"}}>Motor Driving School</p>
              </div>
            </div>
              </div>
